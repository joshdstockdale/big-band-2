...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create big-band-2-2d27
  fly apps create big-band-2-2d27-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app big-band-2-2d27
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app big-band-2-2d27-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'big-band-2-2d27-staging' does not match app name in config file 'big-band-2-2d27'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name big-band-2-2d27-db
  fly postgres attach --app big-band-2-2d27 big-band-2-2d27-db

  fly postgres create --name big-band-2-2d27-staging-db
  fly postgres attach --app big-band-2-2d27-staging big-band-2-2d27-staging-db
  ```
